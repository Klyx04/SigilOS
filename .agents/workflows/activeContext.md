...
## ✅ DERNIÈRE PR MERGÉE — **#655** (fix Marché : **« cosmétique : Effets · +0 Échangeable : [0] »**) → `dev` = **`31305cdb4`** — branche `fix/marche-lignes-metadonnees` (commit `565888447`, **9 fichiers**, +374 / −47 ; CI **verte** : `Verify & Build` **6 m 22 s** · CodeQL · Analyze · `Filter changed files` ; hook pre-commit vert ; **0 migration** ; branche supprimée)
