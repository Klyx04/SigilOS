...
> **Session en cours :** **fin de l'itération finale du Marché** — il reste **T4** (défauts globaux God) · **T5** (test flaky) · **T1** (garde contrats action↔consommateur) · **T15** (purge cache/CDN, infra) · 1 finition UI · 1 **re-siphon** de données · les **ops** §4. **⚠️ 0 migration** attendue (T7 `WANTED` = **hors itération**).
