...
Consulter la procédure de synchronisation dans `.agents/workflows/sync-game-assets.md` pour transférer les tuiles vers le VPS via `sync-assets.sh` ou exécuter le script de siphonnement directement sur le serveur.
