...
### ⚠️ Restant / à savoir
- **Branche `refonte-module-ganymede`** : 16 commits (15 session 12/08 + Phase I `2c9e4161`) → **PR vers `dev`** (auto-approbation solo). `dev` étant protégé, le merge passe par la PR GitHub.
