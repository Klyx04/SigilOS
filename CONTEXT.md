...
### ⚠️ Restant / à savoir
- **Branche `refonte-module-ganymede`** : 19 commits (15 session 12/08 + Phase I `2c9e4161` + vague UX `467fe0d1` + fix `de632c69` + round 2 `6ca7a6f0`) → **PR vers `dev`** (auto-approbation solo). `dev` étant protégé, le merge passe par la PR GitHub.
