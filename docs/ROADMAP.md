...
- ✅ **Session 13/09/2026 (suite 4) — Module « Marché » · S8 lot 4 : « Supervision & clôture » — LE MVP EST FERMÉ** (branche `feat/marche-s8-lot4` depuis `dev` = `55b238e5c` ; plan **§18 · §19.1 · §21 S8 lot 4 · §22** ; mémo `src/temp/memo-2026-09-13-marche-s8-lot4.md`) :
  ...
  - ⚪ RESTE (hors code) : **DoD visuelle** dark/light/mobile de `/god/market` · **crontab `market-expire`** à poser sur le VPS (`MAINTENANCE.md:65`) · `S4.12` beta 2 comptes Discord · `S3.13`/`S6` = V1.1 (jamais ouverts).
...
- ✅ **Session 13/09/2026 (suite 5) — Module « Marché » · clôture : `S3.13` (tags de forum), **correctif bloquant RBAC** et carte Discord « tooltip Dofus »** (branche `feat/marche-cloture` depuis `dev` = `c734b6f9e` ; mémo `src/temp/memo-2026-09-13-marche-cloture.md`) :
