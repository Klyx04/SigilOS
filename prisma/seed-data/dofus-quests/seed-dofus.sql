...
VALUES
  ...
  (gen_random_uuid(), 'argente',             'Dofus Argenté',           'Argenté',    'Argenté',          'MAJEUR',     false, 120, '/module-dofus/Dofus_Argente.png',            '#94a3b8', 19, 'Dofus argenté brillant.',                  'Argent Pur',         now(), now()),
  ...
  (gen_random_uuid(), 'tachete',             'Dofus Tacheté',           'Tacheté',    'Tacheté',          'MINEUR',     false, 70,  '/module-dofus/Dofus_Tachete.png',            '#78716c', 22, 'Dofus moucheté de Wabbit Island.',         'Tacheté',            now(), now()),
