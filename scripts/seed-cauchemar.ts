...
async function main() {
  ...
  console.log("🚀 Starting CLI Seed for Dofus du Cauchemar...");
  ...
  try {
    ...
    const filePath = "prisma/seed-data/dofus-quests/cauchemar-compiled.json";
    const dofusId = createdItems["du-cauchemar"];
