            ...
            sequences: [
                {
                    ...
                    isOptional: false,
                    isResume: false,
                    note: "Choisir Bonta OU Brâkmar — pas de vraie différence. Suivre le guide correspondant à son alignement.",
                    dungeonDbIds: [47, 48, 34, 21],
                    questDbIds: [82, 83, 153],
                    mapPositions: [{ x: -6, y: -37, label: "Maître des Clefs" }],
                },
                {
                    order: 2,
                    subGuideRef: "GP9B",
                    subGuideName: "Alignement Brâkmarien",
                    stepFrom: 1,
                    stepTo: 6,
                    isPartial: true,
                    isOptional: false,
                    isResume: false,
                    note: "Variante Brâkmarien — GP9B. Importer les deux JSON depuis le God Panel avant de re-seeder.",
                    dungeonDbIds: [47, 48, 34, 21],
                    questDbIds: [82, 83, 153],
                    mapPositions: [{ x: 6, y: -37, label: "Maître des Clefs (Brâkmar)" }],
                },
            ],
        },
            ...
            sequences: [
                {
                    ...
                    isOptional: false,
                    isResume: true,
                    note: "Finaliser les 105 quêtes d'alignement commencées au chapitre 2 (GP9 = Bontarien, GP9B = Brâkmarien)",
                    dungeonDbIds: [],
                    questDbIds: [],
                    mapPositions: [],
                },
                {
                    ...
                    isOptional: false,
                    isResume: true,
                    note: "Variante Brâkmarien — continuer GP9B depuis l'étape où on s'est arrêté",
                    dungeonDbIds: [],
                    questDbIds: [],
                    mapPositions: [],
                },
