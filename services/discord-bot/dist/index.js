...
client.on(Events.GuildCreate, async (guild) => {
    ...
    try {
        ...
        try {
            ...
            const targetChannel = guild.systemChannel || guild.channels.cache.find(c => c.type === ChannelType.GuildText &&
...
async function updateDiscordActivity(discordId, guildId, data, activityType) {
    try {
