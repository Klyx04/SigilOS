        ...
        <Card className="glass-premium relative overflow-hidden group border-white/5 hover:border-amber-500/20 transition-all min-h-[380px] flex flex-col">
            ...
            <CardHeader className="pb-2">
                <div className="flex items-center justify-between">
                    ...
                    <Badge variant="outline" className="border-border text-[8px] font-black uppercase text-muted-foreground tracking-tighter">Meryde</Badge>
                </div>
            </CardHeader>
                    ...
                    <div className="space-y-6 animate-in fade-in duration-700">
                        ...
                        <div className="flex items-start gap-4 p-4 rounded-2xl bg-foreground/[0.02] border border-border group-hover:bg-foreground/[0.04] transition-colors">
                            ...
                            <div className="space-y-1">
                                <p className="text-[9px] font-black text-muted-foreground uppercase tracking-widest leading-none">Offrande</p>
                                ...
                                {almanax.reward_kamas && (
                                    <div className="text-[10px] font-bold text-amber-600 dark:text-amber-500/80">+{almanax.reward_kamas.toLocaleString()} kamas</div>
                                )}
                            </div>
                        </div>
                        ...
                        <div className="bg-amber-500/5 border border-amber-500/10 p-4 rounded-2xl relative overflow-hidden flex-1 group/bonus">
                            ...
                            <div className="relative z-10 space-y-2">
                                <div className="flex items-center gap-2">
                                    ...
                                    <p className="text-[9px] font-black text-amber-500 uppercase tracking-widest italic">{almanax.bonus.type?.name || "Bonus du jour"}</p>
                                </div>
                                <p className="text-[11px] font-bold text-muted-foreground leading-relaxed italic tracking-tight line-clamp-3">
                                    « {almanax.bonus.description} »
                                </p>
                            </div>
                        </div>

                        <Link href={`/dashboard/${guildId}/ressources?tab=almanax`} className="block text-center text-[10px] font-black text-muted-foreground hover:text-amber-600 dark:hover:text-amber-500 uppercase tracking-[0.2em] transition-colors py-2">
                            Voir le calendrier →
                        </Link>
                    </div>
                ) : (
