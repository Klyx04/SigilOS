        ...
        <Card className="glass-premium h-full overflow-hidden group hover:border-yellow-500/30 transition-all border-white/10 relative">
            ...
            <CardContent className="p-0 h-full flex flex-row relative" >
                <div className="p-5 flex-1 flex flex-col justify-between min-w-0">
                    <div className="flex items-center justify-between gap-4">
                        <div className="space-y-0.5">
                            <span className="text-[9px] font-black text-yellow-500/80 uppercase tracking-[0.3em] block italic">PANTHÉON DU SIGIL</span>
                    ...
                    <div className="flex items-center gap-3 py-1 overflow-x-auto scrollbar-hide">
                        {topLadder.length > 0 ? (
                                    ...
                                    >
                                        <div className="relative">
                                            ...
                                            <div className="absolute -top-1.5 -right-1.5 z-10">
                                                {i === 0 && (
                                                    <div className="bg-yellow-500 rounded-full p-0.5 shadow-[0_0_15px_rgba(234,179,8,0.5)]">
                                        ...
                                        <div className="flex flex-col min-w-0">
                                            <span className="text-[11px] font-black text-white truncate max-w-[80px] leading-tight uppercase tracking-tight">
                                                {displayName}
                                            </span>
                                            <div className="flex items-center gap-1.5 text-zinc-500 group-hover/entry:text-yellow-500/80 transition-colors">
                                                ...
                                                <span className="text-[10px] font-mono font-black tracking-tighter">{entry.value}</span>
                                            </div>
                                        </div>
                                    </motion.div>
                                );
                            ...
                            <div className="flex items-center gap-4 py-2 px-4 rounded-2xl bg-white/[0.02] border border-white/5 opacity-50">
                                ...
                                <div className="space-y-0.5">
                                    <p className="text-[10px] font-black uppercase tracking-widest text-zinc-400">Arène Vide</p>
                                    <p className="text-[8px] font-bold text-zinc-600 uppercase">Soyez le premier à briller cette semaine !</p>
                                </div>
                            </div>
                        )}
                    </div>
                ...
                <div className="hidden lg:flex w-32 bg-yellow-500/[0.03] border-l border-white/5 p-4 flex-col items-center justify-center relative overflow-hidden group-hover:bg-yellow-500/[0.06] transition-all">
                    <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(234,179,8,0.1),transparent_70%)] opacity-0 group-hover:opacity-100 transition-opacity duration-700" />
                    <div className="relative">
                        <Trophy className="w-12 h-12 text-yellow-500/20 group-hover:text-yellow-500/40 group-hover:scale-125 group-hover:rotate-12 transition-all duration-700" />
                        <motion.div
                            animate={{ rotate: 360 }}
