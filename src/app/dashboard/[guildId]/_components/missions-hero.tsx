...
import { ScrollText, ArrowRight, Zap, BookOpen } from "lucide-react";
...
export function MissionsHero({ 
    ...
    return (
        <div className="relative">
            <Card className="relative bg-surface border-border overflow-hidden rounded-[2rem] min-h-[220px] flex flex-col md:flex-row items-center">
                ...
                <CardContent className="flex-1 p-8 md:p-10 flex flex-col md:flex-row items-center gap-8 z-10 w-full">
                    ...
                    <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-4">
                        <div className="p-4 bg-success/10 rounded-2xl border border-success/20 relative group- transition-transform duration-300">
                            ...
                            <Zap className="w-5 h-5 text-warning absolute -top-1 -right-1" />
                        </div>
                        <div>
                    ...
                    <div className="w-full md:w-auto flex flex-col gap-3">
                        <Link href={`/dashboard/${guildId}/missions`} className="w-full h-full">
                            <Button className="w-full md:w-56 h-16 bg-success hover:bg-success text-success-foreground font-black uppercase tracking-widest text-lg rounded-2xl transition-colors group/btn border-t border-border-strong">
                                REJOINDRE
