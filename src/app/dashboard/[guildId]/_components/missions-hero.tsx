    ...
    return (
        <div className="relative group">
            ...
            <Card className="relative glass-premium border-white/5 overflow-hidden rounded-[2rem] min-h-[220px] flex flex-col md:flex-row items-center border-t-emerald-500/20">
                ...
                <div className="absolute -bottom-24 -right-24 w-64 h-64 bg-emerald-500/10 rounded-full blur-3xl pointer-events-none animate-pulse" />
                    ...
                    <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-4">
                        ...
                        <div>
                            <h2 className="text-3xl md:text-5xl font-black tracking-tighter text-foreground uppercase italic">
                                Missions <span className="text-emerald-600 dark:text-emerald-500">de Guilde</span>
                            </h2>
