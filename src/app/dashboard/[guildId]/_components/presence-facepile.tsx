                        ...
                        <TooltipTrigger asChild>
                            ...
                            >
                                ...
                                <div className={`absolute -bottom-0.5 -right-0.5 w-2.5 h-2.5 rounded-full border-2 border-zinc-950 ${
                                    isAfk ? 'bg-amber-400 shadow-[0_0_6px_rgba(251,191,36,0.7)]' : 'bg-emerald-500 shadow-[0_0_6px_rgba(16,185,129,0.7)]'
                                }`} />
                            </motion.div>
                        </TooltipTrigger>
                        <TooltipContent side="top" className="bg-zinc-900 border-white/10 text-[10px] font-black uppercase tracking-widest py-1.5 px-2.5 mb-2 flex items-center gap-1.5">
                            <span>{user.name}</span>
                            {isAfk ? (
