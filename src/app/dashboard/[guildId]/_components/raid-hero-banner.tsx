                    ...
                    {countdown ? (
                        <div className="flex flex-col items-start md:items-end gap-1">
                            ...
                            <div className="flex items-center gap-1 font-mono">
                                {countdown.h > 0 && (
                                    <>
                                        <span className="text-2xl font-black text-red-400 tabular-nums">{pad(countdown.h)}</span>
                                        <span className="text-sm text-zinc-600 font-black">h</span>
                                    </>
                                )}
                                <span className="text-2xl font-black text-red-400 tabular-nums">{pad(countdown.m)}</span>
                                <span className="text-sm text-zinc-600 font-black">m</span>
                                <span className="text-2xl font-black text-red-300 tabular-nums animate-pulse">{pad(countdown.s)}</span>
                                <span className="text-sm text-zinc-600 font-black">s</span>
                            </div>
                        </div>
                    ) : (
