...
import { Loader2, Save, AlertTriangle, Hash, Handshake } from "lucide-react";
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <Card className="lg:col-span-2 bg-zinc-900/60 border-white/5">
                    <CardHeader>
                        ...
                        <CardDescription>
                            Configurez le salon où seront publiées les demandes d'échange Ocre via Discord.
                        </CardDescription>
                    </CardHeader>
                        ...
                        <CardContent className="pt-6 relative">
                            ...
                            <div className="flex items-start gap-4">
                                <div className="w-10 h-10 rounded-full bg-emerald-500 flex items-center justify-center shrink-0">
                                    <Handshake className="w-5 h-5 text-zinc-950" />
                                </div>
                                <div className="flex-1 min-w-0">
                                    <div className="flex items-baseline gap-2 mb-1">
                                        <span className="font-medium text-emerald-400">SigilOS</span>
                                        <span className="bg-emerald-500/20 text-emerald-300 text-[10px] px-1 rounded">BOT</span>
                                        <span className="text-xs text-zinc-500">Maintenant</span>
                                    </div>

                                    {/* Embed */}
                                    <div className="bg-[#2b2d31] rounded border-l-4 border-emerald-400 p-4 max-w-sm">
                                        <div className="flex items-center gap-2 mb-2">
                                            <span className="text-lg">🤝</span>
                                            <h4 className="font-semibold text-white text-sm">Demande d'échange</h4>
                                        </div>

                                        <p className="text-zinc-300 text-sm mb-4">
                                            <span className="text-emerald-400 font-medium hover:underline cursor-pointer">Wylan</span> recherche <span className="font-semibold text-white">Abrakne</span> (Archi).
                                        </p>

                                        <div className="flex gap-6">
                                            <div>
                                                <div className="text-[#b5bac1] text-xs font-bold uppercase tracking-wider mb-1">Membre Contacté</div>
                                                <div className="text-zinc-200 text-sm">Tourte</div>
                                            </div>
                                            <div>
                                                <div className="text-[#b5bac1] text-xs font-bold uppercase tracking-wider mb-1">Action</div>
                                                <div className="text-zinc-200 text-sm">Allez sur le Dashboard</div>
                                            </div>
                                        </div>

                                        <div className="mt-3 pt-3 border-t border-[#3f4147] flex items-center gap-2">
                                            <div className="w-4 h-4 rounded-full bg-zinc-700" />
                                            <span className="text-[#949ba4] text-xs">SigilOS • Quête Ocre</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
