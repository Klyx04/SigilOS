        ...
        <div className="relative h-full w-full overflow-hidden rounded-md">
            ...
            <div className="relative z-10 p-2 h-full flex flex-col gap-6">
                ...
                <section className="grid md:grid-cols-3 gap-6">
                    <Card className="md:col-span-2 bg-black/40 border-white/10 backdrop-blur-md shadow-2xl relative overflow-hidden group">
                        ...
                        <CardHeader>
                            <CardTitle className="text-4xl font-extrabold tracking-tight lg:text-5xl bg-clip-text text-transparent bg-gradient-to-br from-white to-white/60">
                        ...
                        <CardContent>
                            ...
                            <div className="mt-6 flex gap-3">
                                <Button asChild className="bg-white/10 hover:bg-white/20 text-foreground border border-white/10 backdrop-blur">
                    ...
                    <Card className="bg-black/40 border-white/10 backdrop-blur-md flex flex-col justify-center items-center text-center p-6 relative overflow-hidden">
                ...
                <section className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 flex-1">
                    {/* Placeholder Modules */}
                    <Card className="bg-black/20 border-white/5 hover:border-primary/50 transition-colors cursor-pointer group">
                        <CardHeader>
                    ...
                    <Card className="bg-black/20 border-white/5 hover:border-purple-500/50 transition-colors cursor-pointer group">
                        <CardHeader>
                    ...
                    <Card className="bg-black/10 border-white/5 border-dashed flex flex-col items-center justify-center text-muted-foreground/50 p-6 min-h-[150px]">
