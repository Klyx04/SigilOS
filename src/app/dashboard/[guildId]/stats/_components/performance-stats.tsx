    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="p-5 rounded-xl border border-white/10 bg-white/5 space-y-2">
                ...
                <p className="text-caption uppercase text-zinc-500 tracking-wider font-bold">Moyenne de validation</p>
            </div>
            ...
            <div className="p-5 rounded-xl border border-white/10 bg-white/5 space-y-2">
                ...
                <p className="text-caption uppercase text-zinc-500 tracking-wider font-bold">Performance Globale</p>
            </div>
                ...
                <div className="flex flex-wrap gap-2">
                    {performance.topValidatorsMonth.map((user, i) => (
                        <div key={i} className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 border border-white/10">
                            ...
                            <span className="text-zinc-500 text-caption ml-1">{user.value}</span>
                        </div>
                    ))}
