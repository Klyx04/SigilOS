                ...
                <ResizableSidebar className="hidden lg:block w-64 shrink-0">
                    <div className="sticky top-24 pr-4">
                        <div className="pb-6 border-b border-white/5 mb-6">
                            <Link href="/docs" className="flex items-center gap-2 text-sm font-bold text-zinc-400 hover:text-white transition-colors mb-2">
                            ...
                            <Link
                                ...
                                className="flex items-center gap-2 text-xs font-medium text-zinc-500 hover:text-indigo-400 transition-colors mb-4 group"
                            >
                                <Layout className="w-3 h-3 group-hover:scale-110 transition-transform" />
