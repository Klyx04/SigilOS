...
const PRESET_PACKS = [
    {
        ...
        category: "classes",
        icons: [
            { name: "Iop", emoji: "⚔️", url: "/assets/dofus/classes/8.png" },
            { name: "Cra", emoji: "🏹", url: "/assets/dofus/classes/9.png" },
            { name: "Eniripsa", emoji: "💉", url: "/assets/dofus/classes/7.png" },
            { name: "Feca", emoji: "🛡️", url: "/assets/dofus/classes/1.png" },
            { name: "Sacrieur", emoji: "🩸", url: "/assets/dofus/classes/11.png" },
            { name: "Sadida", emoji: "🌿", url: "/assets/dofus/classes/10.png" },
            { name: "Osamodas", emoji: "🐉", url: "/assets/dofus/classes/2.png" },
            { name: "Enutrof", emoji: "⛏️", url: "/assets/dofus/classes/3.png" },
            { name: "Sram", emoji: "💀", url: "/assets/dofus/classes/4.png" },
            { name: "Xelor", emoji: "⏳", url: "/assets/dofus/classes/5.png" },
            { name: "Pandawa", emoji: "🍺", url: "/assets/dofus/classes/12.png" },
            { name: "Roublard", emoji: "💣", url: "/assets/dofus/classes/13.png" },
            { name: "Zobal", emoji: "🎭", url: "/assets/dofus/classes/14.png" },
            { name: "Steamer", emoji: "⚓", url: "/assets/dofus/classes/15.png" },
            { name: "Eliotrope", emoji: "🌀", url: "/assets/dofus/classes/16.png" },
            { name: "Huppermage", emoji: "✨", url: "/assets/dofus/classes/17.png" },
            { name: "Ouginak", emoji: "🐺", url: "/assets/dofus/classes/18.png" },
            { name: "Forgelance", emoji: "🔱", url: "/assets/dofus/classes/20.png" },
        ]
    },
    {
        name: "Métiers Dofus",
