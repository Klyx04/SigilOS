...
export const metadata: Metadata = {
    ...
    description: "Toutes vos questions sur SigilOS, la sécurité de vos données Dofus et le fonctionnement de l'application.",
};
    ...
    return (
        <div className="space-y-12">
            ...
            <div className="bg-amber-500/5 border border-amber-500/20 rounded-2xl p-6 relative overflow-hidden group">
                ...
                <div className="relative z-10 flex flex-col sm:flex-row gap-4 items-start sm:items-center text-amber-500/90">
                    <div className="p-3 bg-amber-500/10 rounded-xl shrink-0">
                        <ShieldCheck className="w-6 h-6 text-amber-500" />
                    </div>
                    <div>
                        <h3 className="font-black tracking-tight text-white mb-1">Votre sécurité d'abord</h3>
            ...
            <div className="space-y-12">
                ...
                <section>
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <h2 className="text-xl font-bold text-white tracking-tight">Général & Découverte</h2>
                    </div>
                    <Accordion type="single" collapsible className="w-full space-y-4">
                        <AccordionItem value="item-1" className="border border-white/5 bg-zinc-900/30 rounded-xl px-4 overflow-hidden shadow-lg data-[state=open]:border-indigo-500/30 transition-colors">
                            <AccordionTrigger className="hover:no-underline py-4 text-sm font-semibold text-white/90 hover:text-white group">
                        ...
                        <AccordionItem value="item-2" className="border border-white/5 bg-zinc-900/30 rounded-xl px-4 overflow-hidden shadow-lg data-[state=open]:border-indigo-500/30 transition-colors">
                            <AccordionTrigger className="hover:no-underline py-4 text-sm font-semibold text-white/90 hover:text-white">
                        ...
                        <AccordionItem value="item-3" className="border border-white/5 bg-zinc-900/30 rounded-xl px-4 overflow-hidden shadow-lg data-[state=open]:border-indigo-500/30 transition-colors">
                            <AccordionTrigger className="hover:no-underline py-4 text-sm font-semibold text-white/90 hover:text-white">
                        ...
                        <AccordionItem value="item-4" className="border border-white/5 bg-zinc-900/30 rounded-xl px-4 overflow-hidden shadow-lg data-[state=open]:border-indigo-500/30 transition-colors">
                            <AccordionTrigger className="hover:no-underline py-4 text-sm font-semibold text-white/90 hover:text-white">
                                Qui a créé SigilOS ?
                            </AccordionTrigger>
                            <AccordionContent className="text-zinc-400 leading-relaxed text-sm pb-4">
                                SigilOS a été conçu et développé bénévolement par <strong className="text-white">Wylan</strong>, un développeur passionné par l'univers de Dofus et par la cybersécurité. Le projet est né de la volonté de sécuriser et simplifier la gestion des guildes. Vos données sont donc entre de bonnes mains !
                            </AccordionContent>
                        </AccordionItem>
                    </Accordion>
                </section>
                ...
                <section>
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <h2 className="text-xl font-bold text-white tracking-tight">Sécurité & Confidentialité</h2>
                    </div>
                    <Accordion type="single" collapsible className="w-full space-y-4">
                        <AccordionItem value="item-sec-1" className="border border-white/5 bg-zinc-900/30 rounded-xl px-4 overflow-hidden shadow-lg data-[state=open]:border-emerald-500/30 transition-colors">
                            <AccordionTrigger className="hover:no-underline py-4 text-sm font-semibold text-white/90 hover:text-white">
                        ...
                        <AccordionItem value="item-sec-2" className="border border-white/5 bg-zinc-900/30 rounded-xl px-4 overflow-hidden shadow-lg data-[state=open]:border-emerald-500/30 transition-colors">
                            ...
                            <AccordionContent className="text-zinc-400 leading-relaxed text-sm pb-4 space-y-2">
                                ...
                                <p>De plus, toutes les données sensibles (comme votre clé API Metamob ou les jetons de connexion Discord) sont systématiquement <strong className="text-white">chiffrées de bout en bout</strong> dans notre base de données. Même en cas d'accès physique à nos serveurs, ces informations sont illisibles.</p>
                            </AccordionContent>
                        </AccordionItem>
                        <AccordionItem value="item-sec-3" className="border border-white/5 bg-zinc-900/30 rounded-xl px-4 overflow-hidden shadow-lg data-[state=open]:border-emerald-500/30 transition-colors">
                            <AccordionTrigger className="hover:no-underline py-4 text-sm font-semibold text-white/90 hover:text-white">
                ...
                <section>
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <h2 className="text-xl font-bold text-white tracking-tight">Fonctionnement & Utilisation</h2>
                    </div>
                    <Accordion type="single" collapsible className="w-full space-y-4">
                        <AccordionItem value="item-func-1" className="border border-white/5 bg-zinc-900/30 rounded-xl px-4 overflow-hidden shadow-lg data-[state=open]:border-pink-500/30 transition-colors">
                            <AccordionTrigger className="hover:no-underline py-4 text-sm font-semibold text-white/90 hover:text-white">
                                Le lien avec Metamob, comment ça marche ?
                            </AccordionTrigger>
                            <AccordionContent className="text-zinc-400 leading-relaxed text-sm pb-4">
                                En renseignant votre clé API Metamob (une clé de lecture seule fournie par le site Metamob) et votre pseudo, SigilOS va synchroniser vos captures d'Archimonstres de manière sécurisée. Cela permet à votre guilde de voir qui possède quels monstres pour s'entraider sur la quête de l'Ocre. <strong className="text-white">Les mots de passe Metamob ne sont jamais demandés.</strong>
                            </AccordionContent>
                        </AccordionItem>
                        <AccordionItem value="item-func-2" className="border border-white/5 bg-zinc-900/30 rounded-xl px-4 overflow-hidden shadow-lg data-[state=open]:border-pink-500/30 transition-colors">
                            <AccordionTrigger className="hover:no-underline py-4 text-sm font-semibold text-white/90 hover:text-white">
                        ...
                        <AccordionItem value="item-func-3" className="border border-white/5 bg-zinc-900/30 rounded-xl px-4 overflow-hidden shadow-lg data-[state=open]:border-pink-500/30 transition-colors">
                            <AccordionTrigger className="hover:no-underline py-4 text-sm font-semibold text-white/90 hover:text-white">
                                Comment ajouter SigilOS à ma propre guilde ?
                            </AccordionTrigger>
                            <AccordionContent className="text-zinc-400 leading-relaxed text-sm pb-4">
                                SigilOS est actuellement un projet en bêta fermée. L'accès est limité à certaines guildes partenaires pour garantir la stabilité et la qualité du service. Cependant, si vous êtes <strong>Meneur ou Officier d'une guilde ambitieuse</strong>, vous pouvez formuler une demande d'accès en rejoignant le serveur Discord officiel du projet : <a href="https://discord.gg/uX7G6SUDgN" target="_blank" rel="noreferrer" className="text-indigo-400 hover:text-indigo-300 underline font-semibold transition-colors">Rejoindre le Discord SigilOS</a>.
                            </AccordionContent>
                        </AccordionItem>
                    </Accordion>
                </section>
