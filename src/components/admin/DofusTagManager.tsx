            ...
            <div className="flex flex-col gap-6 bg-zinc-950/40 p-6 rounded-3xl border border-white/5 backdrop-blur-md">
                <div className="flex items-center justify-between">
                   <div>
                        ...
                        <p className="text-caption text-zinc-500 font-bold uppercase tracking-widest mt-1">Gérez vos tags et créez des coquilles vides</p>
                   </div>
                   <button 
                        onClick={() => setShowCreate(!showCreate)}
                        className={`flex items-center gap-2 px-5 py-2.5 rounded-2xl font-black uppercase text-caption tracking-widest transition-all ${showCreate ? 'bg-rose-500/10 text-rose-500 border border-rose-500/20' : 'bg-indigo-600 text-white hover:bg-indigo-500 shadow-lg shadow-indigo-600/20'}`}
                   >
                        ...
                        >
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 bg-white/[0.02] p-4 rounded-2xl border border-white/5">
                                <div className="space-y-1">
                                    <label className="text-caption font-black uppercase text-zinc-500 tracking-widest ml-2">Nom du Dofus</label>
                                    <input 
                                        type="text" 
                                ...
                                <div className="space-y-1">
                                    <label className="text-caption font-black uppercase text-zinc-500 tracking-widest ml-2">Slug (URL)</label>
                                    <input 
                                        type="text" 
                                        placeholder="ex: forgelave"
                                        value={newItem.slug}
                                ...
                                <div className="space-y-1">
                                    <label className="text-caption font-black uppercase text-zinc-500 tracking-widest ml-2">Rareté</label>
                                    <input 
                                        type="text" 
                                        list="rarities"
                                ...
                                <div className="flex items-end pb-0.5">
                                    <button 
                                        ...
                                        className="w-full h-10 bg-emerald-600 hover:bg-emerald-500 disabled:opacity-30 disabled:hover:bg-emerald-600 text-white font-black uppercase text-caption tracking-widest rounded-xl transition-all shadow-lg shadow-emerald-950"
                                    >
                ...
                <div className="flex flex-wrap gap-4 items-center">
                    <div className="flex items-center gap-3">
                        <span className="text-caption font-black uppercase text-zinc-600 tracking-widest">Vos Raretés :</span>
                        <div className="flex flex-wrap gap-2">
                            {uniqueRarities.map(r => (
                                <span key={r} className="px-2 py-0.5 bg-zinc-800 border border-white/5 rounded text-caption font-bold text-zinc-400 uppercase">{r}</span>
                            ))}
                        </div>
                    </div>
                    <div className="w-px h-4 bg-white/10" />
                    <div className="flex items-center gap-3">
                        <span className="text-caption font-black uppercase text-zinc-600 tracking-widest">Vos Catégories :</span>
                        <div className="flex flex-wrap gap-2">
                            {uniqueCategories.map(c => (
                                <span key={c} className="px-2 py-0.5 bg-indigo-500/10 border border-indigo-500/20 rounded text-caption font-bold text-indigo-400 uppercase">{c}</span>
                            ))}
                        </div>
                    </div>
                </div>
                    ...
                    <table className="w-full">
                        <thead>
                            <tr className="border-b border-white/5 bg-white/[0.02]">
                                <th className="text-left px-5 py-3 text-caption font-black uppercase tracking-widest text-zinc-500">Dofus</th>
                                <th className="text-center px-4 py-3 text-caption font-black uppercase tracking-widest text-zinc-500">Rareté / Tag Principal</th>
                                {TAG_CONFIG.map((tag) => (
                                    <th key={tag.key} className="text-center px-4 py-3 text-caption font-black uppercase tracking-widest text-zinc-500 whitespace-nowrap">
                                        {tag.label}
                                    </th>
                                ))}
                                <th className="text-center px-4 py-3 text-caption font-black uppercase tracking-widest text-zinc-500 whitespace-nowrap">Catégorie Filtre</th>
                                <th className="text-center px-4 py-3 text-caption font-black uppercase tracking-widest text-zinc-500">Ordre</th>
                                <th className="text-center px-4 py-3 text-caption font-black uppercase tracking-widest text-zinc-500">Actions</th>
                            </tr>
                        </thead>
                                    ...
                                    >
                                        ...
                                        <td className="px-5 py-3">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-caption text-zinc-600 font-medium">{item.slug}</p>
                                                </div>
                                        ...
                                        <td className="px-4 py-3">
                                            <input
                                                ...
                                                className="w-full max-w-[120px] mx-auto block bg-black/40 border border-white/10 rounded-lg px-2 py-1 text-caption font-black uppercase tracking-widest text-white text-center focus:outline-none focus:border-white/30"
                                            />
                                        </td>
                                        ...
                                        <td className="px-4 py-3">
                                            <input
                                                ...
                                                className="w-full max-w-[100px] mx-auto block bg-black/40 border border-white/10 rounded-lg px-2 py-1 text-caption font-black uppercase tracking-widest text-zinc-500 text-center focus:outline-none focus:border-white/30"
                                            />
                                        </td>
