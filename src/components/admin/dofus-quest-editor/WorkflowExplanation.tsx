            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-1">
                        <h3 className="font-black text-white uppercase text-caption tracking-[0.2em] text-indigo-400">La Coquille Vide</h3>
                        <p className="text-caption text-zinc-500 leading-relaxed font-bold">
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-1">
                        <h3 className="font-black text-white uppercase text-caption tracking-[0.2em] text-sky-400">Structure du Modèle</h3>
                        <p className="text-caption text-zinc-500 leading-relaxed font-bold">
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-1">
                        <h3 className="font-black text-white uppercase text-caption tracking-[0.2em] text-emerald-400">Compilation</h3>
                        <p className="text-caption text-zinc-500 leading-relaxed font-bold">
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-1">
                        <h3 className="font-black text-white uppercase text-caption tracking-[0.2em] text-amber-400">Déploiement</h3>
                        <p className="text-caption text-zinc-500 leading-relaxed font-bold">
