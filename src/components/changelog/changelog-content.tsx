    ...
    return (
        <div
            className={cn(
                ...
                "prose-h1:text-xl prose-h1:text-foreground prose-h1:mb-4",
                "prose-h2:text-lg prose-h2:text-warning prose-h2:border-b prose-h2:border-border prose-h2:pb-2",
                "prose-h3:text-base prose-h3:text-info",
                // Texte
                "prose-p:text-sm prose-p:text-foreground prose-p:leading-relaxed prose-p:mb-4",
                "prose-strong:text-foreground prose-strong:font-bold",
                // Listes
                "prose-ul:list-disc prose-ul:ml-4 prose-li:text-sm prose-li:text-foreground prose-li:my-1",
                ...
                "[&_.callout]:my-4 [&_.callout]:p-4 [&_.callout]:rounded-xl [&_.callout]:bg-surface [&_.callout]:border [&_.callout]:border-border",
                "[&_.callout\\ strong]:text-foreground [&_.callout\\ strong]:font-bold [&_.callout\\ strong]:uppercase [&_.callout\\ strong]:tracking-wider [&_.callout\\ strong]:text-caption",
                // Images / figures
                "[&_img]:max-w-full [&_img]:h-auto [&_img]:max-h-[380px] [&_img]:object-contain [&_img]:rounded-xl [&_img]:border [&_img]:border-border [&_img]:my-3 [&_img]:mx-auto",
                ...
                "[&_th]:border [&_th]:border-border [&_th]:px-2 [&_th]:py-1.5 [&_th]:text-foreground [&_th]:font-bold",
                "[&_td]:border [&_td]:border-border [&_td]:px-2 [&_td]:py-1.5 [&_td]:text-foreground",
                className
            )}
            // nosemgrep
