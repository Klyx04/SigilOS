    ...
    return (
        <TooltipProvider delayDuration={0}>
            <Tooltip>
                ...
                <TooltipContent
                    side={side}
                    className="bg-indigo-600 text-white border-none font-bold text-[11px] px-3 py-2 shadow-[0_4px_12px_rgba(0,0,0,0.5)] max-w-[200px]"
                >
                    <div className="flex flex-col gap-1">
                        <span className="uppercase tracking-widest text-[9px] opacity-70">Aide</span>
                        <p>{description}</p>
                    </div>
                </TooltipContent>
            </Tooltip>
