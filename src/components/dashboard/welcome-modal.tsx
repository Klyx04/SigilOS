            ...
            {isOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-6">
                    ...
                    <motion.div
                        ...
                        className="relative w-full max-w-2xl glass-premium rounded-3xl border border-white/15 overflow-hidden shadow-[0_0_50px_rgba(99,102,241,0.2)]"
                    >
                        ...
                        <div className="relative z-10 p-8 md:p-12 flex flex-col items-center text-center space-y-8">
                            ...
                            <div className="relative">
                                ...
                                <div className="relative w-20 h-20 rounded-[2rem] bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center shadow-2xl">
                            ...
                            <div className="space-y-4">
                                ...
                                <p className="text-zinc-400 font-medium max-w-md mx-auto text-lg leading-relaxed">
                            ...
                            <div className="flex flex-col sm:flex-row items-center gap-4 pt-6 w-full max-w-md">
                                <Button
                                    asChild
                                    className="w-full h-14 bg-white text-black hover:bg-zinc-200 font-black uppercase tracking-[0.15em] text-xs rounded-2xl group"
                                >
                                ...
                                <Button
                                    variant="ghost"
                                    onClick={handleClose}
                                    className="w-full h-14 text-zinc-500 hover:text-white hover:bg-white/5 font-black uppercase tracking-[0.15em] text-xs rounded-2xl"
                                >
                                    Plus tard
                                </Button>
                            </div>
