  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md bg-zinc-950/95 border border-white/5 rounded-[2rem] p-6 text-white outline-none">
        ...
        {/* Alignement */}
        <p className="text-[10px] font-black uppercase tracking-widest text-zinc-500 mb-2">Alignement</p>
        ...
        {a && (
          <>
            <p className="text-[10px] font-black uppercase tracking-widest text-zinc-500 mb-2">Ordre</p>
            ...
            {selectedOrder && (
              <>
                <p className="text-[10px] font-black uppercase tracking-widest text-zinc-500 mb-2">Tranche</p>
