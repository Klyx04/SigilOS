    ...
    return (
        <div className="relative group overflow-hidden mb-6">
            ...
            <div className={cn(
                ...
                "bg-background/40 border-warning/30 hover:border-warning/50 "
            )}>
                <div className="flex items-center gap-4 text-center md:text-left">
                    <div className="h-12 w-12 rounded-xl bg-warning/10 flex items-center justify-center border border-warning/20 shrink-0">
                        <AlertTriangle className="h-6 w-6 text-warning animate-bounce duration-300" />
                    </div>
                    ...
                    <div className="space-y-1">
                        ...
                        <p className="text-sm text-muted-foreground max-w-xl leading-relaxed">
                            ...
                            } <span className="text-warning font-semibold italic">(Attention aux majuscules et accents !)</span>
                        </p>
                    </div>
                </div>
                ...
                <Link
                    ...
                    className="flex items-center gap-2 group/btn px-6 py-3 rounded-xl bg-warning text-warning-foreground font-black text-sm uppercase tracking-widest hover:bg-warning transition-all shadow-lg shadow-amber-500/20  active:scale-95"
                >
