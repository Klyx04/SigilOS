        ...
        <Popover open={isOpen} onOpenChange={handleOpenChange}>
            <PopoverTrigger asChild>
                <Button variant="ghost" size="icon" className={cn("relative text-muted-foreground hover:text-foreground transition-colors", className)}>
                    ...
                    {unreadCount > 0 && (
                        <span className="absolute -top-1 -right-1 flex min-w-[1.125rem] h-4.5 px-1 items-center justify-center rounded-full bg-success text-[10px] font-black text-success-foreground ring-2 ring-background animate-in zoom-in duration-200">
