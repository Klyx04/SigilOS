        ...
        <Popover open={isOpen} onOpenChange={setIsOpen}>
            ...
            <PopoverContent className="w-80 p-0 overflow-hidden rounded-2xl border-border bg-[#0d0f11]/95 backdrop-blur-3xl shadow-[0_30px_60px_rgba(0,0,0,0.7)]" align="end">
                <div className="flex items-center justify-between px-4 py-3 border-b border-border bg-surface">
                    ...
                    {unreadCount > 0 && (
                        <Button variant="ghost" size="sm" className="h-auto px-2 py-1 text-caption font-black uppercase tracking-tighter text-muted-foreground hover:text-primary transition-colors" onClick={handleMarkAllRead}>
                            Tout lu
                ...
                {/* Filter Chips */}
                <div className="flex items-center gap-1 p-2 border-b border-border bg-black/20 overflow-x-auto no-scrollbar">
                    {[
                        { id: "ALL", label: "Toutes" },
                            ...
                            <button
                                ...
                                className={cn(
                                    ...
                                    activeCategory === cat.id
                                        ? "bg-info/30 text-info border-info/40"
