...
export function QuickToolsPanel() {
    return (
        ...
        >
            ...
            {/* Sections */}
            <div className="flex-1 overflow-y-auto divide-y divide-white/5" style={{ maxHeight: 460 }}>
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="flex items-center gap-1.5">
                                        <span className="text-xs font-bold text-white group-hover:opacity-80 transition-opacity">
                                            {tool.title}
                                        </span>
                                        {tool.badge && (
                                            <span
