        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td>+15 Vi (3 PWR)</td>
                    <td>+50 Vi (10 PWR)</td>
                    <td>0.2 par point (1 PWR = 5 Vi)</td>
                </tr>
                <tr>
                    <td><strong>Stats Élémentaires (Fo, Ine, Cha, Age)</strong></td>
                    <td>+1 Stat (1 PWR)</td>
                    <td>+3 Stat (3 PWR)</td>
                ...
                <tr>
                    <td><strong>Prospection / Puissance</strong></td>
                    <td>+1 (3 PWR) / +1 Pui (2 PWR)</td>
                    <td>+3 (9 PWR) / +3 Pui (6 PWR)</td>
                    <td>+10 (30 PWR) / +10 Pui (20 PWR)</td>
                    <td>3 (PP) / 2 (Puissance)</td>
                </tr>
                <tr>
                    <td><strong>Dommages Élémentaires / Fixes</strong></td>
                    <td>+1 Do (5 PWR)</td>
                    <td>+3 Do (15 PWR)</td>
                    <td>-</td>
                    <td>5 par point</td>
                ...
                <tr>
                    <td><strong>Soins / Esquives / Retraits</strong></td>
                    <td>+1 Soin/Esq/Ret (10 PWR)</td>
                    <td>+3 Soin/Esq/Ret (30 PWR)</td>
                    <td>-</td>
                    <td>7 (Soin) / 7 (Retrait/Esquive)</td>
                </tr>
                <tr>
                    <td><strong>Résistances Fixes & % Résistance</strong></td>
                ...
                <tr>
                    <td><strong>Coups Critiques (% CC)</strong></td>
                    <td>+1 % Crit (10 PWR)</td>
                    <td>-</td>
                    <td>-</td>
                    <td>10 par point</td>
                ...
                <tr>
                    ...
                    <td>0.1 par point (1 PWR = 10 Ini)</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><span class="inline-flex items-center gap-1.5 font-bold text-cyan-400">+1 Invo</span> (30 PWR)</td>
                    <td>-</td>
                    <td>-</td>
                    <td>30 par point</td>
                </tr>
                <tr>
                    <td>
                        <div class="flex items-center gap-2">
                            <img src="/images/guides/fm/rune_po.png" alt="Rune PO" class="w-6 h-6 object-contain inline-block" />
                            <strong>Portée (PO)</strong>
                        </div>
                    </td>
                    <td><span class="inline-flex items-center gap-1.5 font-bold text-amber-400">+1 PO</span> (51 PWR)</td>
                    <td>-</td>
                    <td>-</td>
                    <td>51 par point</td>
                </tr>
                <tr>
                    <td>
                        <div class="flex items-center gap-2">
                            <img src="/images/guides/fm/rune_ga_pme.png" alt="Rune Ga Pme" class="w-6 h-6 object-contain inline-block" />
                            <strong>Point de Mouvement (PM)</strong>
                        </div>
                    </td>
                    <td><span class="inline-flex items-center gap-1.5 font-bold text-emerald-400">+1 PM</span> (90 PWR)</td>
                    <td>-</td>
                    <td>-</td>
                    <td>90 par point</td>
                </tr>
                <tr>
                    <td>
                        <div class="flex items-center gap-2">
                            <img src="/images/guides/fm/rune_ga_pa.png" alt="Rune Ga Pa" class="w-6 h-6 object-contain inline-block" />
                            <strong>Point d'Action (PA)</strong>
                        </div>
                    </td>
                    <td><span class="inline-flex items-center gap-1.5 font-bold text-rose-400">+1 PA</span> (100 PWR)</td>
                    <td>-</td>
                    <td>-</td>
                    <td>100 par point</td>
                </tr>
